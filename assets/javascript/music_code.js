$(document).ready(function () {
    ...
    function newsApi() {
        ...
        var url = 'https://newsapi.org/v2/everything?sources=mtv-news,buzzfeed,entertainment-weekly,mashable,the-lad-bible,the-huffington-post,mirror&language=en&q=' + artist + '&sortBy=publishedAt&apiKey=f585602033364272b3a51389129301fc';
        ...
        $.ajax({ url: url, method: "GET" }).done(function (response) {
            ...
            for (var i = 0; i < response.articles.length; i++) {
                ...
                console.log(artist);
                console.log(title);
                console.log(title.toLowerCase().includes(artist));
